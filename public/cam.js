  ...
  if (window.JpegCamera) {
    ...
    var take_snapshots = function(count) {
      ...
      if (JpegCamera.canvas_supported()) {
        ...
        image.src = "/static/no_canvas_photo.jpg";
    ...
    var options = {
      shutter_ogg_url: "/static/camtest/shutter.ogg",
      shutter_mp3_url: "/static/camtest/shutter.mp3",
      swf_url: "/static/camtest/jpeg_camera.swf"
    }
